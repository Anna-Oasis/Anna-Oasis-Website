...
const HostelMessDeclaration = () => (
  <div className="p-4">
    <div className="mb-6">
      <Text bold size="lg" className="mb-2 block text-center">
        TAMIL NADU PROHIBITION OF RAGGING ACT 1997
      </Text>
      <Text className="text-base text-gray-700 text-justify leading-relaxed block">
    ...
    <div className="mb-6">
      ...
      <Text className="text-sm text-gray-700 text-justify font-mono leading-relaxed whitespace-pre-line block">
        {HOSTEL_RULES.trim()}
      </Text>
    </div>
    <Divider />
